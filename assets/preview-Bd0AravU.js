import{d as _}from"./index-fSN1-QT7.js";import"./iframe-c9USJka_.js";import"../sb-preview/runtime.js";const{useMemo:f,useEffect:y}=__STORYBOOK_MODULE_PREVIEW_API__,{global:E}=__STORYBOOK_MODULE_GLOBAL__,{logger:M}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var g="backgrounds",{document:l,window:h}=E,B=()=>h.matchMedia("(prefers-reduced-motion: reduce)").matches,x=(r,e=[],n)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let d=e.find(a=>a.name===n);if(d)return d.value;if(n){let a=e.map(i=>i.name).join(", ");M.warn(_`
    ...
    `},[o]);return y(()=>{let b=e.viewMode==="docs"?`addon-backgrounds-grid-docs-${e.id}`:"addon-backgrounds-grid";if(!i){v(b);return}S(b,$)},[i,$,e]),r()},R=[L,A],G={[g]:{grid:{cellSize:20,opacity:.5,cellAmount:5},values:[{name:"light",value:"#F8F8F8"},{name:"dark",value:"#333333"}]}},H={[g]:null};export{R as decorators,H as globals,G as parameters};
//# sourceMappingURL=preview-Bd0AravU.js.map
